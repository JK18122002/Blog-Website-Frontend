  ...
  const createBlogHandler = async () => {
    try {
      ...
      const res = await axios.post(
        `https://blog-website-backend-eejk.onrender.com/api/v1/blog/`,
        { title, category },
        {
          headers: {
    ...
    <div className="p-4 md:pr-20 h-screen md:ml-[320px] pt-20">
      <Card className="md:p-10 p-4 dark:bg-gray-800">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-2">
          Start by giving your blog a clear title and selecting a category that best matches your content.
        </p>
        ...
        <div className="mt-10">
          ...
          <div className="mt-4 mb-5">
            ...
            <Select onValueChange={getSelectedCategory}>
              <SelectTrigger className="w-[220px] bg-white dark:bg-gray-700">
